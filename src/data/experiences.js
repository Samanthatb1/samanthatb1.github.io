...
project: I built a monitoring + alerting system that proactively flags Spark jobs at risk of running out of memory. I designed informed heuristics (e.g., retries/failure occurrences, heap utilization >95%, and consistency over time) by analyzing past incidents and Spark job failures within Stripe. I designed the dashboard which surfaced the heuristics, with and heatmaps showing monthly performance and insights into how to improve memory usage. This gave teams a clear, prioritized view of their most critical jobs, along with with an explanation of why they were marked as risky. The dashboard was paired with a daily job that pinpoints the highest risk Spark jobs and alerts teams to apply improvements, reducing firefighting after failures. To validate my project, I interviewed numerous teams across Stripe to gather feedback on the tool and incorporated their requests into the final system.`,
...
project: I worked with my team to build a new onboarding flow for publicly traded companies to sign up with Stripe, replacing a manual verification process that required placeholder data and document uploads. A portion of the project I owned was introducing stock information to the account object, allowing public companies to input their stock and ticker information. The second portion I owned was the executor authorization page, which allows c-level employees to sign off on the account creation. I implemented these changes across React, Ruby, and GraphQL, adding API support for stock metadata and executive authorization. I worked closely with designers, account managers, and legal to handle complex edge cases in account approval.`,
  ...
  },
  {
    ...
    description:`    I lead the Women in Engineering (WiE) committee at the University of Waterloo. I’ve acted as the president since 2024, the Vice President since 2023, and a General Director before that. Every day I see firsthand how powerful a strong community of women could be, and it has been my goal over the past 5 years within this committee to expand our outreach across UWaterloo. I have led teams of 30 directors, run dozens of events, and made significant progress in uniting gender minority groups across UWaterloo and Canada.

My responsibilities are split across leading the members of the committee, planning initiatives for the student body, and liaising with the university. I grew our Discord membership from 300 to over 1700 UWaterloo students by implementing themed challenges, “Questions of the Day”, and channels for newly admitted students to ask upper-years questions, all of which have fostered student engagement and connection.
